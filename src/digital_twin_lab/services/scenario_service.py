    ...
    _CATALOG: tuple[dict[str, Any], ...] = (
        {
            ...
            "lap_range": (1, 12),
            "assumptions": ["Pacejka MF-94 tire model", "Stable rider adaptation"],
            "metadata": {
                "proposed_setup": {
                    "front_rebound": 9,
                    "rear_rebound": 11,
        ...
        {
            "scenario_id": "catalunya-aero-balance",
            "name": "Catalunya aerodynamic balance — high-downforce vs low-drag",
            "scenario_type": "setup_change",
            "circuit_id": "catalunya",
            "session_id": "qualifying",
            "baseline_setup_id": "catalunya-baseline",
            "lap_range": (1, 8),
            "assumptions": ["Dry track", "Hard compound"],
            "metadata": {
                "proposed_setup": {
                    "front_rebound": 10,
                    "rear_rebound": 12,
                    "rear_ride_height_mm": 43,
                    "engine_map": "mapping_2",
                },
                "ambient_temp_c": 26.0,
                "track_temp_c": 38.0,
        ...
        {
            "scenario_id": "qatar-night-rebound",
            "name": "Qatar night race rear rebound optimisation",
            "scenario_type": "setup_change",
            "circuit_id": "qatar",
            "session_id": "race",
            "baseline_setup_id": "qatar-baseline",
            "lap_range": (1, 22),
            "assumptions": ["Night race — lower ambient", "Medium compound"],
            "metadata": {
                "proposed_setup": {
                    "front_rebound": 8,
                    "rear_rebound": 11,
        ...
        {
            "scenario_id": "phillip-island-high-speed-setup",
            "name": "Phillip Island high-speed stability window",
            "scenario_type": "setup_change",
            "circuit_id": "phillip_island",
            "session_id": "fp1",
            "baseline_setup_id": "phillip-island-baseline",
            "lap_range": (1, 10),
            "assumptions": ["Cool weather — lower thermal load", "Soft compound"],
            "metadata": {
                "proposed_setup": {
                    "front_rebound": 11,
                    "rear_rebound": 13,
